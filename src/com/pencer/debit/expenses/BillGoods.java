 ...
 * @author maina
 */
public class BillGoods extends javax.swing.JInternalFrame {
     ...
     */
    public BillGoods(java.sql.Connection conn, javax.swing.JDesktopPane jdp) {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Item Code", "Item Description", "Quantity", "Price", "Totals"
            }
        ) {
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        if(jTable1.getSelectedColumn()==0){
            ...
            sd=new com.pencer.search.SearchDialog(true, connection, "SELECT item_description,price,measure_unit FROM goods ",
            ...
            sd.addSearchDialogListener(new javax.swing.event.ListSelectionListener(){
                ...
                public void valueChanged(javax.swing.event.ListSelectionEvent lse){
                    ...
                    java.lang.Object desc=sd.getSearchJTable().getValueAt(selectedIndex, 0);
                    java.lang.Object price=sd.getSearchJTable().getValueAt(selectedIndex, 1);
                    ...
                    try{
                        ...
                        java.sql.ResultSet codeRset=codeStt.executeQuery("SELECT code FROM goods WHERE item_description='"+desc+"' AND price='"+price+"'");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(datejTextField.getText()==null||datejTextField.getText().length()<1){
            ...
            javax.swing.JOptionPane.showMessageDialog(this, "The Receipt No. must be specified.",
                    "Receipt No Missing.",
                    javax.swing.JOptionPane.ERROR_MESSAGE);
        
        }else if(outletjTextField.getText()==null||outletjTextField.getText().length()<1){
            javax.swing.JOptionPane.showMessageDialog(this, "The Debit Stream must be specified.",
            ...
            if(rowComplete){
                ...
                try{
                    ...
                    java.sql.PreparedStatement savePS=connection.prepareStatement("INSERT INTO goods_bought (outlet_code, receipt_no, buy_date, item_code, qty, price, totals) VALUES (?,?,?,?,?,?,?)");
                    ...
                    javax.swing.JOptionPane.showMessageDialog(this, "Receipt Data Saved!",
                        "Insert Successful.",
    ...
    public double calculateTableTotals(){
        ...
        for(int r=0;r<jTable1.getRowCount();r++){
            ...
            if(jTable1.getValueAt(r, 3)==null){
